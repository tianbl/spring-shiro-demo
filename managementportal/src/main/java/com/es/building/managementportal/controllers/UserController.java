...
public class UserController {
     ...
     * @return
     */
    @RequestMapping(value = "/es/public/user/login", method = RequestMethod.POST)
    public TsysUser loginTenant(HttpServletRequest request, HttpServletResponse response) throws NoSuchAlgorithmException, InvalidKeyException, BadPaddingException, NoSuchPaddingException, IllegalBlockSizeException {
    ...
    @RequestMapping(value = "/es/user/getDate", method = RequestMethod.POST)
